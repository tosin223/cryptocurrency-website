          ...
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 relative">
              <div className="flex justify-center md:justify-end py-4 md:py-0 md:pb-4 mt-[-1rem]">
                <p>The theme toogle</p>
              </div>
              <p className="text-center md:text-right">Sign up for your theme Toggle</p>
              <div className="py-4">
                <form action="" >
                    <input type="email" className="bg-primary outline-none border border-input p-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto"/>
